...
<style>
  * {{ box-sizing: border-box; margin: 0; padding: 0; }}
  ...
  tr.rank-1 {{ background: #fffbeb !important; border-left: 3px solid #d4af37; }}
  tr.rank-2 td.td-pos {{ color: #607d8b; }}
  tr.rank-2 td.td-total {{ color: #607d8b; }}
  tr.rank-2 {{ background: #f3f3f3 !important; border-left: 3px solid #90a4ae; }}
  tr.rank-3 td.td-pos {{ color: #8b6914; }}
  tr.rank-3 td.td-total {{ color: #8b6914; }}
  tr.rank-3 {{ background: #fdf6ec !important; border-left: 3px solid #c89b3a; }}
