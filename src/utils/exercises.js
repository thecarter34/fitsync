...
export const INITIAL_WORKOUTS = {
  ...
  wednesday: {
    ...
    icon: 'golf',
    exercises: [
      { name: 'Lat Pull-Downs', sets: 3, reps: '10-12', weight: 140, rest: '60 sec', muscle: 'Back/Lats' },
      { name: 'Smith Machine Bent-Over Rows', sets: 3, reps: 10, weight: 145, rest: '60 sec', muscle: 'Back' },
      { name: 'Incline DB Bench', sets: 3, reps: '8-10', weight: 75, rest: '75 sec', muscle: 'Upper Chest' },
      { name: 'DB Lateral Raises', sets: 3, reps: 15, weight: 20, rest: '45 sec', muscle: 'Shoulders' },
      { name: 'Cable Flies', sets: 3, reps: 15, weight: 25, rest: '45 sec', muscle: 'Chest' },
    ],
    finisher: 'Jump rope 500 reps or light air bike 4 rounds',
    notes: 'Golf in the evening — keep this moderate. Mobility focus.',
  },
  thursday: {
    label: 'Rest',
    type: 'rest',
